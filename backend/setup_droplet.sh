...
# Create .env file
cat > .env << EOF
DATABASE_URL=postgresql+asyncpg://doadmin:AVNS_MKce1Vjgkjn1wl5XYuP@skillmatch-postgres-cluster-do-user-23189851-0.i.db.ondigitalocean.com:25060/defaultdb?ssl=require
JWT_SECRET_KEY=skillmatch-super-secret-jwt-key-2025-production-ready-key
DO_SPACES_ACCESS_KEY=DO00MQV9RCFQHM9H37CE
DO_SPACES_SECRET_KEY=374RhsvlsiyTPEl1dBh9OMeEO5d2NryZUNzBCziHcCE
